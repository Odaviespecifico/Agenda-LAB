...
export default function Agenda() {
    ...
    return (_jsxs("div", { className: "w-dvw h-dvh", children: [_jsx(Header, { user: user, setUser: setUser }), _jsxs(SemanaContext, { value: SemanaContextValue, children: [_jsx(ModalContext.Provider, { value: { showRegisterModal }, children: _jsx(ScheduleTable, {}) }), _jsx(RegisterStudent, { ref: modalRef, scheduleDate: scheduleDate })] })] }));
}
...
function RowData({ day, startTime }) {
    ...
    console.log(semana);
    const renderRow = () => {
        return (_jsx(_Fragment, { children: semana.agendamentos
...
function Session({ agendamento }) {
    ...
    if (!agendamento)
        return null;
    return (_jsxs("div", { className: "h-full select-all border-b-2 last-of-type:border-0 px-2 py-1", onClick: handleSectionClick, children: [_jsx("b", { children: "Aluno:" }), " ", agendamento.nome, " ", _jsx("br", {}), _jsxs("b", { children: ["Conte\u00FAdo: ", agendamento.tipo] }), " ", " - " + agendamento.conteúdo, " ", _jsx("br", {}), _jsx("b", { children: "Est\u00E1gio:" }), " ", agendamento.estágio, " ", _jsx("br", {}), _jsx("b", { children: "Respons\u00E1vel:" }), " ", agendamento.responsável, " ", _jsx("br", {})] }));
}
function RegisterStudent({ ref, scheduleDate }) {
    ...
    function handleFormSubmit(e) {
        ...
        if (target && target instanceof HTMLFormElement) {
            ...
            semana.agendamentos.push(new Agendamento(formData.name, formData.estágio, formData.tipo, formData.destalhes, localStorage.getItem('user'), date));
            console.log(semana);
        }
    }
